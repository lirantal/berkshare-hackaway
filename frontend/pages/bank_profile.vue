<template>
    <div class="max-w-4xl">
      <Card>
          ...
          <CardDescription>Your financial profile profile</CardDescription>
          </CardHeader>
          <CardContent>
          <form>
              <div class="grid items-center w-full gap-4">
                <div class="flex flex-col space-y-1.5">
                    ...
                    <Input v-model="opening_balance" id="opening_balance" />
                </div>
                
                <div class="flex flex-col space-y-1.5">
                  <Label for="Fee Per Transaction">Fee Per Transaction</Label>
                  <Input v-model="fee_per_transaction" id="fee_per_transaction" />
                </div>
                
                <div class="flex flex-col space-y-1.5">
                  <Label for="Credit Limit">Credit Limit</Label>
                  <Input v-model="credit_limit" id="credit_limit" />
                </div>
                
                <div class="flex flex-col space-y-1.5">
                  <Label for="Account Number">Account Number</Label>
                  <Input v-model="account_number" id="account_number" />
                </div>
